    ...
    <section id="courses">
      <MDBContainer>
        <div className="courses__courses-text">
          ...
          <h4>
            Confira nosso acervo de cursos das mais variadas categorias para você explorar e se
            tornar um profissional na área de tecnologia
          </h4>
        </div>
        ...
        <div className="courses__courses-image mb-5">
          {/* <img src="" alt="" /> */}
          <img
            src="/images/courses-list-image.jpg"
